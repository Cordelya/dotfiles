...
# Display a weather overview on Login // set the location after the slash to change locations
   curl wttr.in/17314

# Always run these commands as interactive
alias rm='rm -i'
alias cp='cp -i'
alias mv='mv -i'
alias mkdir='mkdir -p'
